...
import com.marcelo.brewer.service.CadastroClienteService;
...
public class ClientesController {
	...
	@Autowired
	private CadastroClienteService cadastroClientesService;
...
//	@PostMapping("/novo")
	...
	public ModelAndView salvar(@Valid Cliente cliente, BindingResult result, RedirectAttributes attributes) {
		...
		try {
			cadastroClientesService.salvar(cliente);
		} catch (Exception e) {
	...
	@GetMapping
	public ModelAndView pesquisar(ClienteFilter clienteFilter, BindingResult bindingResult, @PageableDefault(size = 2) Pageable pageable
