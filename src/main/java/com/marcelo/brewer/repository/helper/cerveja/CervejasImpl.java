package com.marcelo.brewer.repository.helper.cerveja;
...
import com.marcelo.brewer.dto.ValorItensEstoque;
...
public class CervejasImpl implements CervejasQueries{
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new com.marcelo.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new com.marcelo.brewer.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
