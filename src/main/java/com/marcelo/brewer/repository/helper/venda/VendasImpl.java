package com.marcelo.brewer.repository.helper.venda;
	...
	private void adicionarFiltro(VendaFilter filtro, Criteria criteria) {
		...
		if (filtro != null) {
			...
			if (!StringUtils.isEmpty(filtro.getCpfOuCnpjCliente())) {
				criteria.add(Restrictions.eq("c.cpfOuCnpj", TipoPessoa.removerFormatacaoCpfCnpj(filtro.getCpfOuCnpjCliente())));
			}
		}
	}
